...
import { test, register, login, updateUser, deleteUser, updatePassword, registerAdmin, borrowBook } from './user.controller.js'
...
api.post('/borrowBook', [validateJwt], borrowBook)
